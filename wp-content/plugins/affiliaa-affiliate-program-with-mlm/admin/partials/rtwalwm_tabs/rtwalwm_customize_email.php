		  	...
		  	<tbody>
                <?php
					...
					<tr>	 
                        ...
                        <td><input type='button' value='<?php echo esc_html__( 'Edit Email', 'rtwalwm-wp-wc-affiliate-program' ); ?>' class='rtwalwm_customize_email' data-email_type="<?php esc_attr_e($key); ?>" /></td>	
                    </tr>
                    <?php
                        }
                    }
