    ...
    public function  generate_html() {
        ...
        >
            <?php if(!empty($this->logo)):?>
                <img class="notice-logo" style="<?php echo esc_attr($this->logo_style); ?>" src="<?php echo esc_url($this->logo);?>" alt="<?php esc_attr_e('Notice Logo','shopengine-pro'); ?>"/>
            <?php endif; ?>
            ...
            <div class="notice-right-container <?php echo (empty($this->logo) ? 'notice-container-full-width' : ''); ?>">
                    ...
                    <?php if(!empty($this->buttons)): ?>
                        <div class="button-container notice-vert-space">
                            <?php foreach($this->buttons as $button): ?>
                                <a title="<?php esc_html_e('Notification', 'shopengine-pro')?>" id="<?php echo (!isset($button['id']) ? '' : esc_attr($button['id'])); ?>" href="<?php echo esc_url($button['url']); ?>" rel="noopener noreferrer nofollow" class="wpmet-notice-button <?php echo esc_attr($button['class']); ?>">
                ...
                <?php else:?>
                    <?php echo wp_kses($this->html, \ShopEngine_Pro\Util\Helper::get_kses_array()); 
                ?>
                <?php endif;?>
