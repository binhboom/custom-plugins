...
class Badge
{
    ...
    public function init()
    {
        ...
        add_filter('woocommerce_get_price_html', [$this,'custom_format_price_badge'], 10, 2);
    ...
    public function custom_format_price_badge($price, $product) {
        ...
        if ($product->is_type('variable')) {
            ...
            if (!empty($available_variations)) {
                foreach ($available_variations as $variation) {
                    ...
                    if ($sale_price && $regular_price && is_shop() ) {
                        $price = $this->format_price_badge($price, wc_price($regular_price), wc_price($sale_price));
                        break;
                    }
                }
            }
