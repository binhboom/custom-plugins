(function ($) {
  ...
  $(function () {
    ...
    $(document).find(".rtwwwap_select2_cat").select2();
    $(document).find(".rtwwwap_select2_aff").select2();
    ...
    $(document).on("click", ".rtwwwap_add_new_row", function () {
      var rtwwwap_rowCount = $(".rtwwwap_comm_cat_tbody tr").length - 1;
      var rtwwwap_cloned = $(document)
        .find(".rtwwwap_comm_cat_tbody .rtwwwap_add_new_row_hidden")
        .clone();
      $(rtwwwap_cloned).insertAfter(
        $(document).find(".rtwwwap_comm_cat_tbody tr:last-child").last()
      );
      $(document)
    ...
    // for both affiliate + category

    $(document).on("click", ".rtwwwap_add_new_row_aff_cat", function () {
      var rtwwwap_rowCount = $(".rtwwwap_comm_aff_cat_tbody tr").length - 1;
      var rtwwwap_cloned = $(document)
        .find(".rtwwwap_comm_aff_cat_tbody .rtwwwap_add_new_row_hidden")
        .clone();
      $(rtwwwap_cloned).insertAfter(
        $(document).find(".rtwwwap_comm_aff_cat_tbody tr:last-child").last()
      );
      $(document)
        .find(".rtwwwap_comm_aff_cat_tbody tr:last-child")
        .removeClass("rtwwwap_add_new_row_hidden");
      $(document)
        .find(".rtwwwap_comm_aff_cat_tbody tr:last-child")
        .find(".rtwwwap_select2_hidden")
      ...
      // $(document)
      //   .find(".rtwwwap_comm_aff_cat_tbody tr:last-child")
      //   .find(".rtwwwap_select2_aff")
      //   .removeClass("rtwwwap_select2_hidden")
      //   .addClass("rtwwwap_select2");
      //   $(document)
      //   .find(".rtwwwap_comm_aff_cat_tbody tr:last-child")
      //   .find(".rtwwwap_select2_cat")
      //   .removeClass("rtwwwap_select2_hidden")
      //   .addClass("rtwwwap_select2");
      //   $(document)
      //   .find(".rtwwwap_comm_aff_cat_tbody tr:last-child")
      ...
      var rtwwwap_new_row_name_for_aff =
        "rtwwwap_commission_settings_opt[per_aff_cat][" + rtwwwap_rowCount + "][aff_ids][]";
      var rtwwwap_new_row_name_for_cat =
        "rtwwwap_commission_settings_opt[per_aff_cat][" + rtwwwap_rowCount + "][cat_ids][]";
      var rtwwwap_new_row_percentage_name =
        "rtwwwap_commission_settings_opt[per_aff_cat][" +
        rtwwwap_rowCount +
        "][aff_percentage_commission]";
      var rtwwwap_new_row_fixed_name =
        "rtwwwap_commission_settings_opt[per_aff_cat][" +
        rtwwwap_rowCount +
        "][aff_fixed_commission]";

      $(document)
        .find(".rtwwwap_comm_aff_cat_tbody tr:last-child")
        .find(".rtwwwap_class_for_aff")
        .attr("name", rtwwwap_new_row_name_for_aff);
      $(document)
        .find(".rtwwwap_comm_aff_cat_tbody tr:last-child")
        .find(".rtwwwap_class_for_cat")
        .attr("name", rtwwwap_new_row_name_for_cat);
      $(document)
        .find(".rtwwwap_comm_aff_cat_tbody tr:last-child")
        .find(".rtwwwap_cat_percentage_commission")
        .attr("name", rtwwwap_new_row_percentage_name);
      $(document)
        ...
        .find(".rtwwwap_cat_fixed_commission")
        .attr("name", rtwwwap_new_row_fixed_name);
      $(document).find(".rtwwwap_comm_aff_cat_tbody tr:last-child").show();
    });

    // only for affiliate 
    $(document).on("click", ".rtwwwap_add_new_row_aff", function () {
      var rtwwwap_rowCount = $(".rtwwwap_comm_aff_tbody tr").length - 1;
      var rtwwwap_cloned = $(document)
        .find(".rtwwwap_comm_aff_tbody .rtwwwap_add_new_row_hidden")
        .clone();
      $(rtwwwap_cloned).insertAfter(
        $(document).find(".rtwwwap_comm_aff_tbody tr:last-child").last()
      );
      $(document)
        .find(".rtwwwap_comm_aff_tbody tr:last-child")
        .removeClass("rtwwwap_add_new_row_hidden");
      $(document)
        .find(".rtwwwap_comm_aff_tbody tr:last-child")
        .find(".rtwwwap_select2_hidden")
      ...
      var rtwwwap_new_row_name =
        "rtwwwap_commission_settings_opt[per_aff][" + rtwwwap_rowCount + "][ids][]";
      var rtwwwap_new_row_percentage_name =
        "rtwwwap_commission_settings_opt[per_aff][" +
        rtwwwap_rowCount +
        "][aff_percentage_commission]";
      var rtwwwap_new_row_fixed_name =
        "rtwwwap_commission_settings_opt[per_aff][" +
      ...
      $(document)
        ...
        .find(".rtwwwap_cat_fixed_commission")
        .attr("name", rtwwwap_new_row_fixed_name);
      $(document).find(".rtwwwap_comm_aff_tbody tr:last-child").show();
    });
    ...
    $(document).on("click", ".rtwwwap_remove_row_aff", function () {
      $(this).closest("tr").remove();
      var rtwwwap_rowCount = $(".rtwwwap_comm_aff_tbody tr").length;
      if (rtwwwap_rowCount == 1) {
        $(document).find(".rtwwwap_add_new_row_aff").trigger("click");
      }
    });

    // for both category and affiliate
    $(document).on("click", ".rtwwwap_remove_row_aff_cat", function () {
      $(this).closest("tr").remove();
      var rtwwwap_rowCount = $(".rtwwwap_comm_aff_cat_tbody tr").length;
      if (rtwwwap_rowCount == 1) {
        $(document).find(".rtwwwap_add_new_row_aff_cat").trigger("click");
      }
    });
    ...
    $(document).on("click", ".rtwwwap_approve", function () {
      if (confirm(rtwwwap_global_params.rtwwwap_approval_sure)) {
        ...
        var data = {
          ...
          rtwwwap_security_check: rtwwwap_global_params.rtwwwap_nonce,
          rtwwwap_referral_ids: JSON.stringify(rtwwwap_referral_ids),
        };
    ...
    $(document).on("click", ".rtwwwap_payment_paypal", function (e) {
      ...
      var data = {
        ...
        rtwwwap_security_check: rtwwwap_global_params.rtwwwap_nonce,
        rtwwwap_aff_ids: JSON.stringify(rtwwwap_aff_ids),
    ...
    // update code for 8.3.0

    $(document).on('click', '.rtwwwap_generate_csv_payout', function () {
      var rtwwwap_data = {
          action: 'rtwwwap_generate_csv_payout',
          rtwwwap_security_check: rtwwwap_global_params.rtwwwap_nonce
      };
      ...
      $.ajax({
          ...
          success: function (response) {
              if(response.status){
                  ...
                  if (url.indexOf('?') > -1){
                  url += '&payout_csv_download='+response.filename;
                  }else{
                  url += '&payout_csv_download='+response.filename;
                  }
    ...
    $(document).on('click', '.rtwwwap_generate_csv_affiliate', function () {
      var rtwwwap_data = {
          action: 'rtwwwap_generate_csv_affiliate',
          rtwwwap_security_check: rtwwwap_global_params.rtwwwap_nonce
      };
    ...
    $(document).on('click', '.rtwwwap_generate_referral_csv', function () {
      var rtwwwap_data = {
          action: 'rtwwwap_generate_referral_csv',
          rtwwwap_security_check: rtwwwap_global_params.rtwwwap_nonce
      };
      ...
      $.ajax({
          ...
          success: function (response) {
              if(response.status){
                  var url = window.location.href;    
                  if (url.indexOf('?') > -1){
                  url += '&referral_csv_download='+response.filename;
                  }else{
                  url += '&referral_csv_download='+response.filename;
                  }
                  window.location.href = url;
