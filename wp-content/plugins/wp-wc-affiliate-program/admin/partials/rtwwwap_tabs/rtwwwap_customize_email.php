		  	...
		  	<tbody>
                <?php
					...
					<tr>	 
						...
						<?php
if( $key == esc_html__( "Signup Email", "rtwwwap-wp-wc-affiliate-program" ) && $signup_email == "true"){
?>
						...
						?>
                        <td><input type='button' value='<?php echo esc_html__('Edit Email', 'rtwwwap-wp-wc-affiliate-program'); ?>' class='rtwwwap_customize_email' data-email_type="<?php esc_attr_e($key); ?>" /></td>
                    </tr>
                    <?php
                        }
                    }
