...
<table class="rtwwwap-table form-table">
	<tbody>
		...
		<tr>
			<th>
				<?php esc_html_e( 'Note: Commission distribution priority', 'rtwwwap-wp-wc-affiliate-program' ); ?>
			</th>
			<td>
				<p>
					<?php esc_html_e( 'Commission generation priority is structured as follows: "Commission per Affiliate" takes precedence over "Commission per Affiliate per category," followed by "Special offers for affiliate." Subsequently, the hierarchy continues with "Commission per Product," "Commission per Category," and finally "Commission for All Products."', 'rtwwwap-wp-wc-affiliate-program' ); ?>
				</p>
			</td>
		</tr>
		...
		<!-- v8.2.0 update per aff comm -->
		<tr class="rtwwwap_prod_comm <?php if( $rtwwwap_comm_base == 2 ){ echo 'rtwwwap_prod_comm_hide'; } ?>">
			<th><?php esc_html_e( 'Commission per Affiliate', 'rtwwwap-wp-wc-affiliate-program' ); ?></th>
			<td class="tr2">
				<table>
					<thead>
						<th>
							<?php esc_html_e( 'Affiliate Name', 'rtwwwap-wp-wc-affiliate-program' ); ?>
						</th>
						<th>
							<?php esc_html_e( 'Percentage', 'rtwwwap-wp-wc-affiliate-program' ); ?>
						</th>
					...
					<tbody class="rtwwwap_tbody rtwwwap_comm_aff_tbody">
						...
						if(RTWWWAP_IS_WOO == 1) {
							...
							$rtwwwap_all_affiliates = get_users( $rtwwwap_args );
						}
						?>
						<!-- hidden row start-->
						<tr class="rtwwwap_add_new_row_hidden" style="display: none;">
							<td>
								<select class="rtwwwap_select2_hidden" multiple="multiple" id="" name="" data-placeholder="<?php echo esc_attr( 'Select affiliates', 'rtwwwap-wp-wc-affiliate-program' ); ?>">
									<?php
									if( !empty( $rtwwwap_all_affiliates ) ){
										foreach ( $rtwwwap_all_affiliates as $rtwwwap_key => $rtwwwap_user ) {
									?>
										<option value="<?php echo esc_attr( $rtwwwap_user->ID ); ?>" >
									...
									<?php }
										...
										<option value="" >
											<?php esc_html_e( 'No Affiliate', 'rtwwwap-wp-wc-affiliate-program' ); ?>
										</option>
									<?php
									} ?>
								</select>
							...
							<td>
								<input class="rtwwwap_cat_percentage_commission" type="number" min="0" step="0.1" max="100" name="" value="0" />
							</td>
							<td>
								<input class="rtwwwap_cat_fixed_commission" type="number" step="0.1" min="0" name="" value="0" />
							</td>
							<td>
								<span class="dashicons dashicons-plus-alt rtwwwap_add_new_row_aff"></span>
								<span class="dashicons dashicons-dismiss rtwwwap_remove_row_aff"></span>
							</td>
						</tr>
						<!-- hidden row end-->
						<?php
						if( !empty( $rtwwwap_commission_settings ) && isset( $rtwwwap_commission_settings[ 'per_aff' ] ) && !empty( $rtwwwap_commission_settings[ 'per_aff' ] ) ){
							foreach( $rtwwwap_commission_settings[ 'per_aff' ] as $rtwwwap_key => $rtwwwap_value ){ ?>
						<tr>
							<td>
								<select class="rtwwwap_select2" multiple="multiple" id="" name="rtwwwap_commission_settings_opt[per_aff][<?php echo esc_attr( $rtwwwap_key ); ?>][ids][]" data-placeholder="<?php echo esc_attr( 'Select affiliates', 'rtwwwap-wp-wc-affiliate-program' ); ?>" >
									<?php
									$rtwwwap_selected = '';
									foreach ( $rtwwwap_all_affiliates as $rtwwwap_key1 => $rtwwwap_user1 )
									{
										if(isset($rtwwwap_value[ 'ids' ])){
											if( in_array( $rtwwwap_user1->ID, $rtwwwap_value[ 'ids' ] ) ){
									...
									?>
										<option value="<?php echo esc_attr( $rtwwwap_user1->ID ); ?>" <?php selected( $rtwwwap_selected, 'yes' ); ?> >
											<?php echo esc_html( $rtwwwap_user1->data->display_name ); ?>
										</option>
									<?php
									}
									?>
							...
							<td>
								<input class="rtwwwap_cat_percentage_commission" type="number" min="0" max="100" step="0.1" name="rtwwwap_commission_settings_opt[per_aff][<?php echo esc_attr( $rtwwwap_key ); ?>][aff_percentage_commission]" value="<?php echo isset( $rtwwwap_value[ 'aff_percentage_commission' ] ) ? esc_attr( $rtwwwap_value[ 'aff_percentage_commission' ] ) : esc_attr( '0' ); ?>" />
							</td>
							<td>
								<input class="rtwwwap_cat_fixed_commission" type="number" min="0" step="0.1" name="rtwwwap_commission_settings_opt[per_aff][<?php echo esc_attr( $rtwwwap_key ); ?>][aff_fixed_commission]" value="<?php echo isset( $rtwwwap_value[ 'aff_fixed_commission' ] ) ? esc_attr( $rtwwwap_value[ 'aff_fixed_commission' ] ) : esc_attr( '0' ); ?>" />
							</td>
							<td>
								<span class="dashicons dashicons-plus-alt rtwwwap_add_new_row_aff"></span>
								<span class="dashicons dashicons-dismiss rtwwwap_remove_row_aff"></span>
						...
						<tr>
							<td>
								<select class="rtwwwap_select2" multiple="multiple" id="" name="rtwwwap_commission_settings_opt[per_aff][0][ids][]" data-placeholder="<?php echo esc_attr( 'Select affiliates', 'rtwwwap-wp-wc-affiliate-program' ); ?>">
								<?php
									if( !empty( $rtwwwap_all_affiliates ) ){
										foreach ( $rtwwwap_all_affiliates as $rtwwwap_key => $rtwwwap_user ) {
									?>
							...
							<td>
								<input class="rtwwwap_cat_percentage_commission" type="number" min="0" max="100" step="0.1" name="rtwwwap_commission_settings_opt[per_aff][0][aff_percentage_commission]" value="0" />
							</td>
							<td>
								<input class="rtwwwap_cat_fixed_commission" type="number" min="0" step="0.1" name="rtwwwap_commission_settings_opt[per_aff][0][aff_fixed_commission]" value="0" />
							</td>
							<td>
								<span class="dashicons dashicons-plus-alt rtwwwap_add_new_row_aff"></span>
								<span class="dashicons dashicons-dismiss rtwwwap_remove_row_aff"></span>
		...
		<!-- v8.2.0 update per aff + category comm -->
		<tr class="rtwwwap_prod_comm <?php if( $rtwwwap_comm_base == 2 ){ echo 'rtwwwap_prod_comm_hide'; } ?>">
			<th><?php esc_html_e( 'Commission per Affiliate per category', 'rtwwwap-wp-wc-affiliate-program' ); ?></th>
			<td class="tr2">
				<table>
					<thead>
						<th>
					...
					<tbody class="rtwwwap_tbody rtwwwap_comm_aff_cat_tbody">
						...
						<tr class="rtwwwap_add_new_row_hidden" style="display: none;">
							<td>
								<select class="rtwwwap_select2_hidden rtwwwap_class_for_aff" multiple="multiple" id="" name="" data-placeholder="<?php echo esc_attr( 'Select affiliates', 'rtwwwap-wp-wc-affiliate-program' ); ?>">
									<?php
									if( !empty( $rtwwwap_all_affiliates ) ){
										foreach ( $rtwwwap_all_affiliates as $rtwwwap_key => $rtwwwap_user ) {
									?>
							...
							<!-- for categories -->
							<td>
								<select class="rtwwwap_select2_hidden rtwwwap_class_for_cat" multiple="multiple" id="" name="" data-placeholder="<?php echo esc_attr( 'Select categories', 'rtwwwap-wp-wc-affiliate-program' ); ?>">
									<?php
							...
							<td>
								<span class="dashicons dashicons-plus-alt rtwwwap_add_new_row_aff_cat"></span>
								<span class="dashicons dashicons-dismiss rtwwwap_remove_row_aff_cat"></span>
							</td>
						</tr>
						<!-- hidden row end-->
						<?php
						if( !empty( $rtwwwap_commission_settings ) && isset( $rtwwwap_commission_settings[ 'per_aff_cat' ] ) && !empty( $rtwwwap_commission_settings[ 'per_aff_cat' ] ) ){
							foreach( $rtwwwap_commission_settings[ 'per_aff_cat' ] as $rtwwwap_key => $rtwwwap_value ){ 
							// if( isset($rtwwwap_value[ 'aff_ids' ]) && !empty( $rtwwwap_value[ 'aff_ids' ] ) ){
								?>
						<tr>
							<td>
								<select class="rtwwwap_select2 rtwwwap_select2_aff" multiple="multiple" id="" name="rtwwwap_commission_settings_opt[per_aff_cat][<?php echo esc_attr( $rtwwwap_key ); ?>][aff_ids][]" data-placeholder="<?php echo esc_attr( 'Select affiliates', 'rtwwwap-wp-wc-affiliate-program' ); ?>" >
									<?php
									$rtwwwap_selected = '';
									foreach ( $rtwwwap_all_affiliates as $rtwwwap_key1 => $rtwwwap_user1 )
									{
										if(isset($rtwwwap_value[ 'aff_ids' ])){
											if( in_array( $rtwwwap_user1->ID, $rtwwwap_value[ 'aff_ids' ] ) ){
												$rtwwwap_selected = 'yes';
											}
											else{
												$rtwwwap_selected = 'no';
							...
							<!-- for categoies -->
							<td>
								<select class="rtwwwap_select2_hidden rtwwwap_select2_cat" multiple="multiple" id="" name="rtwwwap_commission_settings_opt[per_aff_cat][<?php echo esc_attr( $rtwwwap_key ); ?>][cat_ids][]" data-placeholder="<?php echo esc_attr( 'Select categories', 'rtwwwap-wp-wc-affiliate-program' ); ?>">
								<?php
									$rtwwwap_selected = '';
									foreach ( $rtwwwap_all_categories as $rtwwwap_key1 => $rtwwwap_category1 )
									{
										if(isset($rtwwwap_value[ 'cat_ids' ]) && !empty($rtwwwap_value[ 'cat_ids' ])){
											if( in_array( $rtwwwap_category1->cat_ID, $rtwwwap_value[ 'cat_ids' ] ) ){
												$rtwwwap_selected = 'yes';
											}
											else{
												$rtwwwap_selected = 'no';
							...
							<td>
								<input class="rtwwwap_cat_percentage_commission" type="number" min="0" max="100" step="0.1" name="rtwwwap_commission_settings_opt[per_aff_cat][<?php echo esc_attr( $rtwwwap_key ); ?>][aff_percentage_commission]" value="<?php echo isset( $rtwwwap_value[ 'aff_percentage_commission' ] ) ? esc_attr( $rtwwwap_value[ 'aff_percentage_commission' ] ) : esc_attr( '0' ); ?>" />
							</td>
							<td>
								<input class="rtwwwap_cat_fixed_commission" type="number" min="0" step="0.1" name="rtwwwap_commission_settings_opt[per_aff_cat][<?php echo esc_attr( $rtwwwap_key ); ?>][aff_fixed_commission]" value="<?php echo isset( $rtwwwap_value[ 'aff_fixed_commission' ] ) ? esc_attr( $rtwwwap_value[ 'aff_fixed_commission' ] ) : esc_attr( '0' ); ?>" />
							</td>
							<td>
								<span class="dashicons dashicons-plus-alt rtwwwap_add_new_row_aff_cat"></span>
								<span class="dashicons dashicons-dismiss rtwwwap_remove_row_aff_cat"></span>
						...
						<tr>
							<td>
								<select class="rtwwwap_select2 rtwwwap_select2_aff" multiple="multiple" id="" name="rtwwwap_commission_settings_opt[per_aff_cat][0][aff_ids][]" data-placeholder="<?php echo esc_attr( 'Select affiliates', 'rtwwwap-wp-wc-affiliate-program' ); ?>">
								<?php
									if( !empty( $rtwwwap_all_affiliates ) ){
										foreach ( $rtwwwap_all_affiliates as $rtwwwap_key => $rtwwwap_user ) {
									?>
							...
							<!-- for categories -->
							<td>
								<select class="rtwwwap_select2_hidden rtwwwap_select2_cat" multiple="multiple" id="" name="rtwwwap_commission_settings_opt[per_aff_cat][0][cat_ids][]" data-placeholder="<?php echo esc_attr( 'Select categories', 'rtwwwap-wp-wc-affiliate-program' ); ?>">
									<?php
									if( !empty( $rtwwwap_all_categories ) ){
										foreach ( $rtwwwap_all_categories as $rtwwwap_key => $rtwwwap_category ) {
									?>
							...
							<td>
								<input class="rtwwwap_cat_percentage_commission" type="number" min="0" max="100" step="0.1" name="rtwwwap_commission_settings_opt[per_aff_cat][0][aff_percentage_commission]" value="0" />
							</td>
							<td>
								<input class="rtwwwap_cat_fixed_commission" type="number" min="0" step="0.1" name="rtwwwap_commission_settings_opt[per_aff_cat][0][aff_fixed_commission]" value="0" />
							</td>
							<td>
								<span class="dashicons dashicons-plus-alt rtwwwap_add_new_row_aff_cat"></span>
								<span class="dashicons dashicons-dismiss rtwwwap_remove_row_aff_cat"></span>
		...
		<tr class="rtwwwap_prod_comm <?php if( $rtwwwap_comm_base == 2 ){ echo 'rtwwwap_prod_comm_hide'; } ?>">
			...
			<td class="tr2">
				<table>
					...
					<tbody class="rtwwwap_tbody rtwwwap_comm_cat_tbody">
		...
		<tr>
			<th>
				<?php esc_html_e( 'Commission for only the product URL opened?', 'rtwwwap-wp-wc-affiliate-program' ); ?>
			</th>
			<td class="tr2">
				<p>
					<span class="rtwwwap-custom-radio">
		...
		<tr>
			<th>
				<?php esc_html_e( 'Allow Own Referral', 'rtwwwap-wp-wc-affiliate-program' ); ?>
			</th>
			<td class="tr2">
				<p>
					<span class="rtwwwap-custom-radio">
					   	<input id="radio-17" type="radio" class="rtwwwap_coupons" name="rtwwwap_commission_settings_opt[own_referral]" value="1" <?php isset( $rtwwwap_commission_settings[ 'own_referral' ] ) ? checked( $rtwwwap_commission_settings[ 'own_referral' ], 1 ) : ''; ?> />
					   	<?php esc_html_e( 'Yes', 'rtwwwap-wp-wc-affiliate-program' ); ?>
					...
					<span class="rtwwwap-custom-radio">
						<?php
							$rtwwwap_coupon_checked = 0;
							if( isset( $rtwwwap_commission_settings[ 'own_referral' ] ) && $rtwwwap_commission_settings[ 'own_referral' ] == 0 ){
								$rtwwwap_coupon_checked = 1;
							}
							elseif( !isset( $rtwwwap_commission_settings[ 'own_referral' ] ) ){
								$rtwwwap_coupon_checked = 1;
							}
						?>
					  	<input id="radio-19" type="radio" class="rtwwwap_own_referral" name="rtwwwap_commission_settings_opt[own_referral]" value="0" <?php checked( $rtwwwap_coupon_checked, 1 ); ?> />
					   	<?php esc_html_e( 'No', 'rtwwwap-wp-wc-affiliate-program' ); ?>
					   	<label for="radio-19"></label>
					</span>
				</p>
				<div class="descr">
					<?php esc_html_e( "After Activating this , Own referral commission will be generated ", 'rtwwwap-wp-wc-affiliate-program' ); ?>
				</div>
			</td>
		</tr>
		...
		<tr >
			<th>
				<?php esc_html_e( 'Maximum amount of money an affiliate can withdraw', 'rtwwwap-wp-wc-affiliate-program' ); ?>
			</th>
			<td class="tr2">
				<p>
					<input type="number" name="rtwwwap_commission_settings_opt[maximum_ammount_for_affiliate]" min="1" step="0.1" value="<?php echo isset( $rtwwwap_commission_settings[ 'maximum_ammount_for_affiliate' ] ) ? esc_attr( $rtwwwap_commission_settings[ 'maximum_ammount_for_affiliate' ] ) : esc_attr( 1000 ); ?>" />
				</p>
				<p><?php esc_html_e( 'Enter Amount', 'rtwwwap-wp-wc-affiliate-program' ); ?></p>
			</td>
		</tr>
		...
		<tr >
			<th>
				<?php esc_html_e( 'Minimum amount of money an affiliate needs to withdraw', 'rtwwwap-wp-wc-affiliate-program' ); ?>
			</th>
			<td class="tr2">
				<p>
