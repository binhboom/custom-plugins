...
<table class="rtwwwap-table form-table">
	<tbody>
		...
		<tr>
			<th><?php esc_html_e( 'MLM commission Based', 'rtwwwap-wp-wc-affiliate-program' ); ?></th>
			<td class="tr2">
				<p>
					<span class="rtwalwm-custom-radio">
						<input id="radio-24" type="radio" name="rtwwwap_mlm_opt[mlm_commission_base]" value="0" <?php checked( $rtwwwap_mlm_com_base, 0 ); ?>/> <?php esc_html_e( 'Based on product price', 'rtwwwap-wp-wc-affiliate-program' ); ?>
						<label for="radio-24"></label>
					</span>
				</p>
				<p>
					<span class="rtwalwm-custom-radio">
						<input id="radio-25" type="radio" name="rtwwwap_mlm_opt[mlm_commission_base]" value="1" <?php checked( $rtwwwap_mlm_com_base, 1 ); ?>/><?php esc_html_e( ' Based on the amount earned by the affiliate as commission ', 'rtwwwap-wp-wc-affiliate-program' ); ?>
