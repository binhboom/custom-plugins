<?php
	...
	$rtwwwap_affiliate_template = isset($rtwwwap_extra_features[ 'affiliate_page_template' ]) ? $rtwwwap_extra_features[ 'affiliate_page_template' ] : 1 ;
	...
	if(is_user_logged_in()){
			...
			elseif( !$rtwwwap_is_affiliate ){
				...
				if(isset( $rtwwwap_extra_features[ 'become_title' ] ) && $rtwwwap_extra_features[ 'become_title' ] != '' )
				{
				...
				if(	$rtwwwap_affiliate_template == 1 && $rtwwwap_affiliate_template != '')
				{
					...
					if(!empty($rank_requirement_fields))
					{
						foreach($rank_requirement_fields as $option_name => $option_val ){
							...
							if(!empty($option_val['rank_requirement'])){
					...
					if(($rank_id > $rtwwwap_rank_priority) && $rtwwwap_rank_details1 && $rtwwwap_curn_user_id != 1 ){
				...
				if(	$rtwwwap_affiliate_template == 2 && $rtwwwap_affiliate_template != ' ')
				{
				...
				if(	$rtwwwap_affiliate_template == 3 && $rtwwwap_affiliate_template != ' ')
				{
