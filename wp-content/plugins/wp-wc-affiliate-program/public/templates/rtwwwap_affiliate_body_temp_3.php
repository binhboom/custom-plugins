...
// referral tabels
    ...
    $rtwwwap_html1 .=	'   
                                    ...
                                    <div class="rtwwwap_table_container">
                                        ...
                                        <table class="mdl-data-table" aria-label="Dessert calories" id="rtwwwap-refferral-table" >
                                            ...
                                            <tr>
                                                ...
                                                <th>'.	sprintf( '%s', esc_html__( 'Commission From', 'rtwwwap-wp-wc-affiliate-program' ) ).'</th>
                        ...
                        if( in_array('addon_for_affiliate_referral/affiliate_referral_addon.php', apply_filters('active_plugins', get_option('active_plugins') ) ) )
                        {
                            $rtwwwap_html2 = '';
                            $rtwwwap_html1 .= apply_filters('rtwwwap_add_referral_content', $rtwwwap_html2);
                        }
                        // 
                        $rtwwwap_html1 .=  '</div>
                                    </div>';
                            ...
                            $rtwwwap_html1 .= 					'<span class="rtwwwap_member_close">×</span>';
                            $rtwwwap_html1 .=  						'<h2 ><span class="rtwwwap_member_heading">'; 
                            $rtwwwap_html1 .=   				'</span>';
                            $rtwwwap_html1 .=  esc_html__('Order','rtwwwap-wp-wc-affiliate-program');
                            $rtwwwap_html1 .= 	'<span class="rtwwwap_member_heading">'.esc_html__("Detail","rtwwwap-wp-wc-affiliate-program").'</span>';
                            $rtwwwap_html1 .= '</h2>';
                                    $rtwwwap_html1 .=  '</div>';
