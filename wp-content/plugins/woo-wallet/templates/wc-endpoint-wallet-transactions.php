...
?>
<a href="<?php echo is_account_page() ? esc_url( wc_get_account_endpoint_url( get_option( 'woocommerce_woo_wallet_endpoint', 'my-wallet' ) ) ) : esc_url( get_permalink() );
?>"><span class="dashicons dashicons-editor-break"></span></a></p>
