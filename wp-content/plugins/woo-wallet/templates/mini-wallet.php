...
?>
<li class="menu-item">
	<a class="woo-wallet-menu-contents menu-link" title="<?php echo esc_html_e( 'Current wallet balance', 'woo-wallet' );
	?>" href="<?php echo esc_url( wc_get_account_endpoint_url( get_option( 'woocommerce_woo_wallet_endpoint', 'my-wallet' ) ) ); ?>">
